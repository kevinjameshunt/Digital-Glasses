...
@implementation DGFilterImageFactory
...
+ (NSString *)nameForFilterType:(ISFilterType)filterType
{
    ...
    switch (filterType) {
        case ISFilterTypeNone:
            ...
            break;
        case ISFilterTypeBrightness:
            lookupImageName = kDGBrightnessLabel;
            break;
        case ISFilterTypeContrast:
            lookupImageName = kDGContrastLabel;
            break;
        case ISFilterTypeSaturation:
            lookupImageName = kDGSaturationLabel;
            break;
        default:
            break;
    }
...
+ (DGFilterRange *)filterRangeForFilterType:(ISFilterType)filterType {
    DGFilterRange * newFilter = [DGFilterRange filterWithType:filterType andValue:0];
